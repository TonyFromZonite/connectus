                ...
                <div class="col-xl-8 col-xxl-9 col-lg-8">
                        ...
                        <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-none rounded-xxxl bg-dark overflow-hidden mb-3 mt-3">
                                    <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                        <a href="#">
                                            <span class="btn-round-lg bg-white"><i class="material-icons font-lg">add</i></span>
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3" style="background-image: url(../images/s-1.jpg);">
                                    <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                        <a href="#">
                                            <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1"><img src="../images/user-11.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                            <div class="clearfix"></div>
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3" style="background-image: url(../images/s-2.jpg);">
                                    <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                        <a href="#">
                                            <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1"><img src="../images/user-12.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                            <div class="clearfix"></div>
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3">
                                    ...
                                    <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                        <a href="#">
                                            <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1"><img src="../images/user-9.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                            <div class="clearfix"></div>
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3 ms-1">
                                    ...
                                    <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                        <a href="#">
                                            <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1"><img src="../images/user-4.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                            <div class="clearfix"></div>
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3" style="background-image: url(../images/s-5.jpg);">
                                    <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                        <a href="#">
                                            <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1"><img src="../images/user-3.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                            <div class="clearfix"></div>
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3" style="background-image: url(../images/s-6.jpg);">
                                    <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                        <a href="#">
                                            <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1"><img src="../images/user-2.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                            <div class="clearfix"></div>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                        <div class="card-body p-0 d-flex">
                            ...
                            <a href="#" class="me-auto" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons text-grey-900 btn-round-md bg-greylight font-xss">more_vert</i></a>
                            <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu2">
                                <div class="card-body p-0 d-flex">
                                    <i class= "material-icons  text-grey-500 ms-3 font-lg">bookmark</i>
                                    <h4 class="fw-600 text-grey-900 font-xssss mt-0 ms-4">Save Link <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Add this to your saved items</span></h4>
                                </div>
                                <div class="card-body p-0 d-flex mt-2">
                                    <i class= "material-icons  text-grey-500 ms-3 font-lg">error</i>
                                    <h4 class="fw-600 text-grey-900 font-xssss mt-0 ms-4">Hide Post <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to your saved items</span></h4>
                                </div>
                                <div class="card-body p-0 d-flex mt-2">
                                    <i class= "material-icons  text-grey-500 ms-3 font-lg">error</i>
                                    <h4 class="fw-600 text-grey-900 font-xssss mt-0 ms-4">Hide all from Group <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to your saved items</span></h4>
                                </div>
                                <div class="card-body p-0 d-flex mt-2">
                                    <i class= "material-icons  text-grey-500 ms-3 font-lg">lock</i>
                                    <h4 class="fw-600 mb-0 text-grey-900 font-xssss mt-0 ms-4">Unfollow Group <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to your saved items</span></h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-0 ms-lg-5">
                            <p class="fw-500 text-grey-500 lh-26 font-xssss w-100">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus <a href="#" class="fw-600 text-primary me-2">See more</a></p>
                        </div>
                        ...
                        <div class="card-body d-flex p-0 mt-3">
                            <a href="#" class="emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss ms-2"><i class=" material-icons text-white bg-primary-gradiant ms-1 btn-round-xs font-xss">thumb_up</i> <i class="material-icons text-white bg-red-gradiant ms-2 btn-round-xs font-xss">favorite</i>2.8K Like</a>
                            ...
                            <a href="#" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="material-icons text-primary  btn-round-sm font-lg">message</i><span class="d-none-xss">22 Comment</span></a>
                            <a href="#" id="dropdownMenu21" data-bs-toggle="dropdown" aria-expanded="false" class="me-auto d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="material-icons  text-primary btn-round-sm font-lg">share</i><span class="d-none-xs">Share</span></a>
                            <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu21">
                                <h4 class="fw-700 font-xss text-grey-900 d-flex align-items-center">Share <i class="material-icons me-auto font-xssss btn-round-xs bg-greylight text-grey-900 ms-2">share</i></h4>
                                <div class="card-body p-0 d-flex">
                                ...
                                <div class="card-body p-0 d-flex">
                                    <ul class="d-flex align-items-center justify-content-between mt-2">
                                        <li><a href="#" class="btn-round-lg bg-whatsup"><i class="font-xs material-icons text-white"></i></a></li>
                                ...
                                <i class="material-icons position-absolute left-15 ms-4 mt-3 font-xs text-grey-500">file_copy</i>
                ...
                <div class="col-xl-4 col-xxl-3 col-lg-4 pe-lg-0">
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-0 ">
                        ...
                        <div class="card-body bg-transparent-card d-flex p-3 bg-greylight me-3 ms-3 rounded-3">
                            ...
                            <a href="#" class="btn-round-sm bg-white text-grey-900 material-icons-chevron-right font-xss me-auto mt-2"></a>
                        </div>
                        <div class="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3" style="margin-bottom: 0 !important;">
                            ...
                            <a href="#" class="btn-round-sm bg-white text-grey-900 material-icons-plus font-xss me-auto mt-2"></a>
                        </div>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                        ...
                        <div class="card-body d-flex align-items-center pt-0 pe-4 ps-4 pb-4">
                            <a href="#" class="p-2 lh-28 w-100 bg-grey text-grey-800 text-center font-xssss fw-700 rounded-xl"><i class="material-icons-external-link font-xss ms-2"></i> Like Page</a>
                        </div>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                        ...
                        <div class="card-body d-flex pt-0 pe-4 ps-4 pb-3 overflow-hidden">
                            <div class="bg-success ms-2 p-3 rounded-xxl"><h4 class="fw-700 font-lg ls-3 lh-1 text-white mb-0"><span class="ls-1 d-block font-xsss text-white fw-600">FEB</span>22</h4></div>
                        ...
                        <div class="card-body d-flex pt-0 pe-4 ps-4 pb-3 overflow-hidden">
                            <div class="bg-warning ms-2 p-3 rounded-xxl"><h4 class="fw-700 font-lg ls-3 lh-1 text-white mb-0"><span class="ls-1 d-block font-xsss text-white fw-600">APR</span>30</h4></div>
                        ...
                        <div class="card-body d-flex pt-0 pe-4 ps-4 pb-3 overflow-hidden">
                            <div class="bg-primary ms-2 p-3 rounded-xxl"><h4 class="fw-700 font-lg ls-3 lh-1 text-white mb-0"><span class="ls-1 d-block font-xsss text-white fw-600">APR</span>23</h4></div>

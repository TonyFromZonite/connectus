                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                            <div class="card-body p-0 d-flex">
                                ...
                                <h4 class="fw-700 text-grey-900 font-xssss mt-1">{{ $post->user->name }}
                                    <span
                                        class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">{{ \Carbon\Carbon::parse($post->created_at)->diffForHumans() }}
                                    </span>
                                </h4>
                ...
                <div class="col-xl-4 col-xxl-3 col-lg-4 pe-lg-0">
                    <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                        ...
                        <div class="card-body d-flex pt-0 pe-4 ps-4 pb-0">
                            <figure class="avatar ms-3"><img src="../images/user-8.png" alt="image"
                                    class="shadow-sm rounded-circle w45"></figure>
                        ...
                        <div class="card-body d-flex pt-0 pe-4 ps-4 pb-0">
                            <figure class="avatar ms-3"><img src="../images/user-12.png" alt="image"
                                    class="shadow-sm rounded-circle w45"></figure>
                            <h4 class="fw-700 text-grey-900 font-xssss mt-1">Mohannad Zitoun <span
                                    class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual friends</span>
                            </h4>
